...
`docgen.nix` instantiates docgen with imp-specific settings:
...
The returned attrset contains `docs` (built site derivation), `serveDocsScript`, `buildDocsScript`, and `apiReference` (just the generated markdown).
